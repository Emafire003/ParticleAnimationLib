...
public class CuboidEffect extends TargetedEffect {
    ...
    public static void copy(CuboidEffect original, CuboidEffect copy) {
        ...
        copy.setXLength(original.xLength());
        copy.setYLength(original.yLength());
        copy.setZLength(original.zLength());
    ...
    public static final class Builder {
         ...
         *
         * @param lengths A Vec3 of the xyz lengths to set
         * @return a reference to this Builder
         */
    ...
    protected boolean checkCut(Vec3 pos){
        ...
        Vec3 centerPos = new Vec3(originPos.x()+useXLength/2, originPos.y()+useYLength/2, originPos.z()+useZLength/2);
