...
public class AnimatedBallEffect extends Effect {
    ...
    public static void copy(AnimatedBallEffect original, AnimatedBallEffect copy) {
        ...
        copy.setxFactor(original.xFactor());
        copy.setyFactor(original.yFactor());
        copy.setzFactor(original.zFactor());
        copy.setxRotation(original.xRotation());
        copy.setyRotation(original.yRotation());
        copy.setzRotation(original.zRotation());
    }
    ...
    /*@Override
    @Deprecated
    protected boolean checkCut(Vec3 pos){
        //Applicare la box alla orgin pos centrata

        //Should be the position of the center
        Vec3 centerPos = new Vec3(originPos.x()+xFactor/2, originPos.y()+yFactor/2, originPos.z()+zFactor/2);
        ...
        if(cutAboveRightForward.x() != 0 && pos.x() > centerPos.x()+cutAboveRightForward.x()){
            return true;
        }
        if(cutAboveRightForward.y() != 0 && pos.y() > centerPos.y()+cutAboveRightForward.y()){
            return true;
        }
        if(cutAboveRightForward.z() != 0 && pos.z() > centerPos.z()+cutAboveRightForward.z()){
            return true;
        }
        if(cutBelowLeftBackward.x() != 0 && pos.x() > centerPos.x()-cutBelowLeftBackward.x()){
            return true;
        }
        if(cutBelowLeftBackward.y() != 0 && pos.y() > centerPos.y()-cutBelowLeftBackward.y()){
            return true;
        }
        if(cutBelowLeftBackward.z() != 0 && pos.z() > centerPos.z()-cutBelowLeftBackward.z()){
            return true;
        }
        //ParticleAnimationLib.LOGGER.info("Center pos: "+ centerPos.y() + " The curBoveWhaterver" + cutAboveRightForward.y());
        //ParticleAnimationLib.LOGGER.info("The pos: "+ pos.y() + " The cut+center" + (centerPos.y()+cutAboveRightForward.y()));
        return false;
        /*Box box = new Box(centerPos.x()+cutAboveRightForward.x(), centerPos.y()+cutAboveRightForward.y(), centerPos.z()+cutAboveRightForward.z(),
                centerPos.x()-cutBelowLeftBackward.x(), centerPos.y()-cutBelowLeftBackward.y(), centerPos.z()-cutBelowLeftBackward.z());
    ...
    public static final class Builder {
         ...
         *
         * @param factor A Vec3 representing the xyz factors (aka xyz "strech" values) of the effect
         * @return a reference to this Builder
         */
